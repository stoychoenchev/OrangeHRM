...
- Name: Verify that the Configuration list item 8 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:510:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:513:37
```
