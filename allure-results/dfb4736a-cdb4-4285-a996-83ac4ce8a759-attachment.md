...
- Name: Verify that the Configuration list item 7 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:504:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:507:37
```
