...
- Name: Verify that the Organization button is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:274:1
...
Call log:
  ...
  - waiting for getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:277:44
```
