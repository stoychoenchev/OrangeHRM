...
- Name: Verify that the Organization button is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:279:1
...
Locator: getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')
Expected: enabled
Received: <element(s) not found>
Call log:
  - expect.toBeEnabled with timeout 5000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')

    at D:\Automation\OrangeHRM\tests\test.spec.js:282:44
```
