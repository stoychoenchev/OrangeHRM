...
- Name: Verify that the Configuration list item 2 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:426:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:429:37
```
