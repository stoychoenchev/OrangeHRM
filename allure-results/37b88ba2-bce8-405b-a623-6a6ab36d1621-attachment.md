...
- Name: Verify that the Job list item 2 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:220:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Job' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:223:27
```
