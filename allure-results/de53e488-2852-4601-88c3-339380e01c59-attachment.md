...
- Name: Verify that the Qualifications list item 1 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:360:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Qualifications' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:363:38
```
