...
- Name: Verify that the User Management button is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:187:1
...
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:189:17
```
