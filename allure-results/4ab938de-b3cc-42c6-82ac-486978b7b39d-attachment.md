...
- Name: Verify that the Configuration list item 8 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:462:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:465:37
```
