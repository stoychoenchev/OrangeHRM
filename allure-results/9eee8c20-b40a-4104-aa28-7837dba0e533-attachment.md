...
- Name: Verify that the Qualifications list item 4 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:348:1
...
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:350:17
```
