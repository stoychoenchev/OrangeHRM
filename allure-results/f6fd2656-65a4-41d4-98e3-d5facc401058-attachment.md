...
- Name: Verify that the Qualifications list item 3 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:372:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Qualifications' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:375:38
```
