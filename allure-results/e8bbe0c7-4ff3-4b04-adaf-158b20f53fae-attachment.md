...
- Name: Verify that the Qualifactions button is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:320:1
...
Call log:
  ...
  - waiting for getByRole('listitem').filter({ hasText: 'Qualifications' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:323:46
```
