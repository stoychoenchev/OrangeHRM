...
<launching> C:\Users\User\AppData\Local\ms-playwright\firefox-1482\firefox\firefox.exe -no-remote -wait-for-browser -foreground -profile C:\Users\User\AppData\Local\Temp\playwright_firefoxdev_profile-WIAUL4 -juggler-pipe -lang en-US -silent
<launched> pid=18756
[pid=18756][err] JavaScript warning: resource://services-settings/Utils.sys.mjs, line 116: unreachable code after return statement
[pid=18756][out] console.warn: services.settings: Ignoring preference override of remote settings server
[pid=18756][out] console.warn: services.settings: Allow by setting MOZ_REMOTE_SETTINGS_DEVTOOLS=1 in the environment
[pid=18756][out] 
[pid=18756][out] Juggler listening to the pipe
[pid=18756][out] console.error: "Warning: unrecognized command line flag" "-foreground"
[pid=18756][err] JavaScript error: resource://gre/modules/ShortcutUtils.sys.mjs, line 143: TypeError: keyAttribute is null
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6776: TypeError: this.selectedBrowser is undefined
[pid=18756][err] JavaScript error: chrome://juggler/content/TargetRegistry.js, line 152: TypeError: tab.linkedBrowser is undefined
[pid=18756][err] JavaScript error: chrome://juggler/content/Helper.js, line 82: NS_ERROR_FAILURE: Component returned failure code: 0x80004005 (NS_ERROR_FAILURE) [nsIWebProgress.removeProgressListener]
[pid=18756][err] JavaScript error: resource:///modules/sessionstore/SessionStore.sys.mjs, line 3025: TypeError: browser is undefined
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6794: TypeError: this.selectedTab is undefined
[pid=18756][out] console.error: (new TypeError("this.selectedTab is undefined", "chrome://browser/content/tabbrowser/tabbrowser.js", 2676))
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6794: TypeError: this.selectedTab is undefined
[pid=18756][out] console.error: SearchEngineSelector: "Received empty search configuration!"
[pid=18756][out] console.error: SearchEngineSelector: "Received empty search configuration!"
[pid=18756][out] console.error: SearchService: "#init: failure initializing search:" ({})
[pid=18756][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=18756][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=18756][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=18756][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=18756][out] console.error: "Received empty top sites configuration!"
[pid=18756][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=18756][out] console.error: "Received empty top sites configuration!"
[pid=18756][out] console.error: WebExtensions: 
[pid=18756][out]   Message: [Exception... "Failed to get engine data from Remote Settings"  nsresult: "0x8000ffff (NS_ERROR_UNEXPECTED)"  location: "JS frame :: resource://gre/modules/SearchEngineSelector.sys.mjs :: getEngineConfiguration :: line 100"  data: no]
[pid=18756][out]   Stack:
[pid=18756][out]     getEngineConfiguration@resource://gre/modules/SearchEngineSelector.sys.mjs:100:24
[pid=18756][out] 
[pid=18756][out] console.error: "Error in processing browser-idle-startup for GenAI.init"
[pid=18756][out] console.error: (new TypeError("window.gBrowser.selectedBrowser is undefined", "resource:///modules/GenAI.sys.mjs", 352))
[pid=18756][out] console.error: "Error in processing browser-idle-startup for RFPHelper.init"
[pid=18756][out] console.error: (new TypeError("aBrowser is undefined", "resource://gre/modules/RFPHelper.sys.mjs", 586))
[pid=18756][err] JavaScript error: resource:///modules/asrouter/ASRouterTriggerListeners.sys.mjs, line 1357: TypeError: browser is undefined
[pid=18756][out] console.error: SearchSettings: "_write: Could not write to settings file:" (new Error("cannot write without any engine.", "resource://gre/modules/SearchSettings.sys.mjs", 280))
[pid=18756][err] JavaScript error: chrome://juggler/content/Helper.js, line 82: NS_ERROR_FAILURE: Component returned failure code: 0x80004005 (NS_ERROR_FAILURE) [nsIWebProgress.removeProgressListener]
[pid=18756][out] console.error: URLBar - Provider.UrlbarProviderSearchTips: ({})
[pid=18756][err] JavaScript error: resource://gre/modules/BrowserTelemetryUtils.sys.mjs, line 38: TypeError: browser is undefined
[pid=18756][err] JavaScript error: resource:///modules/ProcessHangMonitor.sys.mjs, line 322: TypeError: browser is undefined
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6794: TypeError: this.selectedTab is undefined
[pid=18756][err] JavaScript error: chrome://juggler/content/Helper.js, line 82: NS_ERROR_FAILURE: Component returned failure code: 0x80004005 (NS_ERROR_FAILURE) [nsIWebProgress.removeProgressListener]
[pid=18756][err] JavaScript error: chrome://browser/content/browser.js, line 4653: TypeError: browser is undefined
[pid=18756][err] JavaScript error: chrome://browser/content/browser.js, line 4653: TypeError: browser is undefined
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6776: TypeError: this.selectedBrowser is undefined
[pid=18756][err] JavaScript error: chrome://browser/content/tabbrowser/tabbrowser.js, line 6776: TypeError: this.selectedBrowser is undefined
```
