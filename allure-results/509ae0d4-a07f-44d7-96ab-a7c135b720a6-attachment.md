...
- Name: Verify that the Corporate Branding button is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:400:1
...
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:402:17
```
