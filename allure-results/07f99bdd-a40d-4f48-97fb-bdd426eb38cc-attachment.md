...
- Name: Verify that the Organization list item 2 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:290:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:293:36
```
