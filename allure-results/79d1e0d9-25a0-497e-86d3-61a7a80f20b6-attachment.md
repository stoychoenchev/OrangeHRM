...
- Name: Verify that the Job list item 4 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:232:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Job' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:235:27
```
