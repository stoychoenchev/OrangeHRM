...
- Name: Verify that the Qualifactions button is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:325:1
...
Locator: getByRole('listitem').filter({ hasText: 'Qualifications' }).locator('i')
Expected: enabled
Received: <element(s) not found>
Call log:
  - expect.toBeEnabled with timeout 5000ms
  - waiting for getByRole('listitem').filter({ hasText: 'Qualifications' }).locator('i')

    at D:\Automation\OrangeHRM\tests\test.spec.js:328:46
```
