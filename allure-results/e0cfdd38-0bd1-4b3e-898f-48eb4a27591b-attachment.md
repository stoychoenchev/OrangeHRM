...
- Name: Verify that the Job list item 3 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:226:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Job' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:229:27
```
