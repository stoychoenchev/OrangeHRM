...
Call log:
  - waiting for locator('.oxd-input-group').filter({ has: getByText('Employee Name') }).locator('input[placeholder=\'Type for hints...\']')

    at PimPage.searchForUserRole (D:\Automation\OrangeHRM\pages\PimPage.js:34:37)
    at D:\Automation\OrangeHRM\tests\test.spec.js:533:31
```
