...
- Name: Verify that the Job list item 2 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:250:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Job' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:253:27
```
