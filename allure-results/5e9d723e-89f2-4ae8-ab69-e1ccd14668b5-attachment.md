...
- Name: Verify that the Configuration Branding button is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:410:1
...
Locator: getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
Expected: visible
...
Call log:
  ...
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:413:45
```
...
- table:
  ...
  - rowgroup:
    - row " Admin Admin Primeiro Ultimo Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Admin"
    ...
    - row " Akash ESS Akash p Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " Akash1 ESS Akash p Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Akash1"
    ...
    - row " lakshmana ESS lakshmana Lucky Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " user_1746904427826 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746904427826"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746905145136 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746905145136"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746905395094 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746905395094"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746905610492 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746905610492"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746905688926 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746905688926"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746905849693 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746905849693"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
        - button ""
        - button ""
    - row " user_1746906341870 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746906341870"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 Ali"
      - cell "Enabled"
      - cell " ":
