...
- Name: Verify that we are able to search in Admin Page
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:140:1
...
Call log:
  - waiting for getByRole('option', { name: 'Admin' })
    ...
    at AdminPage.searchForUserRole (D:\Automation\OrangeHRM\pages\AdminPage.js:74:34)
    at D:\Automation\OrangeHRM\tests\test.spec.js:143:5
```
