  ...
  - rowgroup:
    ...
    - row " andy_jassy ESS Andy Jassy Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " user_1746904351518 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746904351518"
      - cell "Admin"
    ...
    - row " user_1746904427826 Admin AaaTestUpdatePlay531 Ali Enabled  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " vasdfre Admin Andy Jassy Disabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "vasdfre"
...
> 471 |     await admin.configurationButton.click();
  ...
  534 |     await expect(assertionOfSearch).toHaveText("Test Testov");
  535 |    await page.pause();
  536 | })
```