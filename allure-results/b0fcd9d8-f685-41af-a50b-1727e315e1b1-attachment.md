...
- Name: Verify that the Organization list item 3 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:314:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:317:36
```
