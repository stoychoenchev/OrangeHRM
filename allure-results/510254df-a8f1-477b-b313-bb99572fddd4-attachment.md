...
- Name: Verify that the Qualifications list item 5 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:354:1
...
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:356:17
```
