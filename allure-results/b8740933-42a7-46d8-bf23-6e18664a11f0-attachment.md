...
<launching> C:\Users\User\AppData\Local\ms-playwright\firefox-1482\firefox\firefox.exe -no-remote -wait-for-browser -foreground -profile C:\Users\User\AppData\Local\Temp\playwright_firefoxdev_profile-D3Zv0r -juggler-pipe -silent
<launched> pid=24480
[pid=24480][err] JavaScript warning: resource://services-settings/Utils.sys.mjs, line 116: unreachable code after return statement
[pid=24480][out] console.warn: services.settings: Ignoring preference override of remote settings server
[pid=24480][out] console.warn: services.settings: Allow by setting MOZ_REMOTE_SETTINGS_DEVTOOLS=1 in the environment
[pid=24480][out] 
[pid=24480][out] Juggler listening to the pipe
[pid=24480][out] console.error: "Warning: unrecognized command line flag" "-foreground"
[pid=24480][err] JavaScript error: chrome://juggler/content/Helper.js, line 82: NS_ERROR_FAILURE: Component returned failure code: 0x80004005 (NS_ERROR_FAILURE) [nsIWebProgress.removeProgressListener]
[pid=24480][out] console.error: SearchEngineSelector: "Received empty search configuration!"
[pid=24480][out] console.error: "Received empty top sites configuration!"
[pid=24480][out] console.error: SearchEngineSelector: "Received empty search configuration!"
[pid=24480][out] console.error: SearchService: "#init: failure initializing search:" ({})
[pid=24480][out] console.error: "Received empty top sites configuration!"
[pid=24480][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=24480][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=24480][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=24480][err] JavaScript error: resource://gre/modules/SearchEngineSelector.sys.mjs, line 100: NS_ERROR_UNEXPECTED: Failed to get engine data from Remote Settings
[pid=24480][out] console.error: WebExtensions: 
[pid=24480][out]   Message: [Exception... "Failed to get engine data from Remote Settings"  nsresult: "0x8000ffff (NS_ERROR_UNEXPECTED)"  location: "JS frame :: resource://gre/modules/SearchEngineSelector.sys.mjs :: getEngineConfiguration :: line 100"  data: no]
[pid=24480][out]   Stack:
[pid=24480][out]     getEngineConfiguration@resource://gre/modules/SearchEngineSelector.sys.mjs:100:24
[pid=24480][out] 
[pid=24480][out] console.error: SearchSettings: "_write: Could not write to settings file:" (new Error("cannot write without any engine.", "resource://gre/modules/SearchSettings.sys.mjs", 280))
[pid=24480][out] console.error: URLBar - Provider.UrlbarProviderSearchTips: ({})
```
