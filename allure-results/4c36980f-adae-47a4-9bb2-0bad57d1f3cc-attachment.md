...
```
Error: page.goto: Navigation to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers" is interrupted by another navigation to "https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index"
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:412:17
```
