...
- Name: Verify that the User Management list item 1 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:198:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'User Management' }).locator('i')

    at D:\Automation\OrangeHRM\tests\test.spec.js:201:38
```
