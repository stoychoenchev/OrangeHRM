...
- Name: Verify that the Configuration list item 3 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:480:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:483:37
```
