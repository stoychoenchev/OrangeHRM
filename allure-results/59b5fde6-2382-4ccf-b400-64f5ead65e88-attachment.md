...
- Name: Verify that the Configuration list item 4 is visible in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:438:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Configuration' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:441:37
```
