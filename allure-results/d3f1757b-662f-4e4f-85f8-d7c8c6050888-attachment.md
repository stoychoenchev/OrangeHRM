...
- Name: Verify that the Organization list item 2 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:308:1
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Organization' }).locator('i')
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:311:36
```
