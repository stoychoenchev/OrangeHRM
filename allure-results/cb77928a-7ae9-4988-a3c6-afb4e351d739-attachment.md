...
- Name: Verify that the Job list item 1 is clickable in AdminPage
- Location: D:\Automation\OrangeHRM\tests\test.spec.js:244:1
...
Call log:
  - navigating to "https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewSystemUsers", waiting until "load"
    ...
    at D:\Automation\OrangeHRM\tests\test.spec.js:246:17
```
