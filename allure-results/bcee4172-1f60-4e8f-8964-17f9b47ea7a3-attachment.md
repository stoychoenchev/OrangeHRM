...
- banner:
  ...
  - list:
    - listitem:
      - img "profile picture"
      - paragraph: AaaTestUpdatePlay531 user
      - text: 
...
- table:
  ...
  - rowgroup:
    - row " 124142 ESS AaaTestUpdatePlay531 user Disabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "124142"
      - cell "ESS"
      - cell "AaaTestUpdatePlay531 user"
      - cell "Disabled"
      - cell " ":
        - button ""
        - button ""
    - row " Admin Admin AaaTestUpdatePlay531 user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "Admin"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " alice Admin AaaTestUpdatePlay531 user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "alice"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " mandauser Admin AaaTestUpdatePlay531 user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "mandauser"
      ...
      - cell " ":
        - button ""
        - button ""
    - row " user_1746909053936 Admin AaaTestUpdatePlay531 user Enabled  ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "user_1746909053936"
      - cell "Admin"
      - cell "AaaTestUpdatePlay531 user"
      - cell "Enabled"
      - cell " ":
